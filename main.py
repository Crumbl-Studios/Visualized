...
if character == 'vr_guy':
    ...
    player = pygame.sprite.GroupSingle(playerHandler.Player(ninja_frog_run, ninja_frog_fall, ninja_frog_jump, jump_sound
                                                            , 284))
elif character == 'mask_dude':
    player = pygame.sprite.GroupSingle(playerHandler.Player(mask_dude_run, mask_dude_fall, mask_dude_jump, jump_sound
                                                            , 284))
elif character == 'pink_man':
    player = pygame.sprite.GroupSingle(playerHandler.Player(pink_man_run, pink_man_fall, pink_man_jump, jump_sound
                                                            , 284))
else:
    player = pygame.sprite.GroupSingle(playerHandler.Player(vr_guy_run, vr_guy_fall, vr_guy_jump, jump_sound, 284))
