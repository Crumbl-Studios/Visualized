...
def get_save_loc():
    ...
    if os.path.join(location,"s.bin"):
        try:
            os.mkdir(location)
            print("Save folder generated... file will be generated by json decoder")
        except FileExistsError:
            print("Save folder found, however s.bin was not found")
    else:
...
save_dir = get_save_loc() # Original code: os.path.join(current_dir, 'bin')
